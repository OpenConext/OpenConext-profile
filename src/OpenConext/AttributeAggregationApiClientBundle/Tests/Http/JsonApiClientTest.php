...
class JsonApiClientTest extends TestCase
{
    ...
    {
        $this->setExpectedException('\OpenConext\AttributeAggregationApiClientBundle\Exception\ResourceNotFoundException');
    ...
    {
        $this->setExpectedException('\OpenConext\AttributeAggregationApiClientBundle\Exception\InvalidResponseException');
